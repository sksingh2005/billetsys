...
import { $createMentionNode } from "@/components/editor/mention-node";
import {
  Command,
  CommandGroup,
  CommandItem,
...
function useMentionLookupService(mentionString: string | null) {
  ...
  const cachedResults =
    mentionString == null ? undefined : mentionsCache.get(mentionString);
  ...
  if (mentionString == null || cachedResults === null) {
    return [];
  }
