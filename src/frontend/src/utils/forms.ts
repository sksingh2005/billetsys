...
export function appendFormValue(searchParams: URLSearchParams, key: string, value: BrowserFormEntry): void {
...
export function appendBrowserFormValue(form: HTMLFormElement, key: string, value: BrowserFormEntry): void {
  if (Array.isArray(value)) {
...
export function submitBrowserForm(url: string, entries: BrowserFormEntries): void {
...
export function createDirectoryUserFormState(bootstrap: DirectoryUserBootstrap): DirectoryUserFormState {
  return {
