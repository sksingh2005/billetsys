...
export function getDirectoryRoutes(sessionState) {
  return [
    { path: '/users', element: <DirectoryUsersPageRoute sessionState={sessionState} apiBase="/api/admin/users" basePath="/users" titleFallback="Users" />, requiresAuth: true },
    ...
    { path: '/support/users', element: <DirectoryUsersPageRoute sessionState={sessionState} apiBase="/api/support/users" basePath="/support/users" titleFallback="Users" />, requiresAuth: true, allowedRoles: ['support'] },
    ...
    { path: '/tam/users', element: <DirectoryUsersPageRoute sessionState={sessionState} apiBase="/api/tam/users" basePath="/tam/users" titleFallback="Users" />, requiresAuth: true, allowedRoles: ['tam'] },
    ...
    { path: '/superuser/users', element: <DirectoryUsersPageRoute sessionState={sessionState} apiBase="/api/superuser/users" basePath="/superuser/users" titleFallback="Users" />, requiresAuth: true, allowedRoles: ['superuser'] },
