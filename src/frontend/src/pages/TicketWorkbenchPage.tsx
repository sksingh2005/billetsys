...
import type { CollectionResponse, TicketWorkbenchListItem } from '../types/domain';

export default function TicketWorkbenchPage({ sessionState }: SessionPageProps) {
  const ticketState = useJson<CollectionResponse<TicketWorkbenchListItem>>('/api/ticket-workbench');
